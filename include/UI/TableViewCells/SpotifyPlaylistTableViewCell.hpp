...
DECLARE_CLASS_CODEGEN(SpotifySearch::UI, SpotifyPlaylistTableViewCell, HMUI::TableCell) {
    ...
    public:
    static constexpr std::string_view CELL_REUSE_ID = "SpotifyPlaylistTableViewCell";
    void setPlaylist(const spotify::Playlist& playlist);

    private:
    void updateBackground();

    std::unique_ptr<const spotify::Playlist> playlist_;
};
